...
function Card({
  ...
  return (
    <div
      className={`rounded-[2rem] border border-white/10 bg-black/35 backdrop-blur-xl shadow-2xl ${className}`}
    >
      {children}
    </div>
  );
...
function PhotoCard({
  ...
  return (
    <div
      className="relative overflow-hidden rounded-[2rem] border border-white/10 shadow-xl"
      style={{ height }}
    >
      <img
        src={image}
          ...
          <div className="relative min-h-[640px]">
            ...
            <div className="relative z-10 flex min-h-[640px] flex-col justify-end p-8 md:p-10">
              ...
              <p className="mt-8 max-w-4xl text-xl leading-10 text-emerald-50/90">
                ...
                agritourism, food access, leadership, and community
                revitalization.
              </p>
        ...
        <div className="space-y-6">
          <Card className="p-7">
            ...
            <p className="mt-6 text-lg leading-9 text-emerald-50/85">
              ...
              leadership, and community participation into one immersive
              ecosystem.
            </p>
          ...
          <PhotoCard
            ...
            subtitle="Food grown here moves toward schools, marketplaces, and families."
            image={IMG.community}
            height="330px"
          />
        </div>
