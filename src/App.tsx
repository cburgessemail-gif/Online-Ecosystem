      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        .operations-visual {
          ...
          background:
            radial-gradient(circle at top right, rgba(83,226,142,.20), transparent 38%),
            linear-gradient(135deg, rgba(11,35,24,.94), rgba(5,8,6,.96));
          border: 1px solid rgba(83,226,142,.24);
          color: white;
        }
